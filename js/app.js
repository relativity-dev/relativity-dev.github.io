...
var SearchActions = SearchActions_1 = (function () {
    ...
    SearchActions.prototype.executeSearch = function (searchText) {
        this.ngRedux.dispatch({
...
var Search = (function (_super) {
    ...
    Search.prototype.onSearchTextChanged = function (value) {
        ...
        if (value.length > 2)
            this.searchActions.executeSearch(value);
    };
    return Search;
}(__WEBPACK_IMPORTED_MODULE_2_angular_l10n__["d" /* Localization */]));
__decorate([
...
var SearchViewModelSelector = (function (_super) {
    ...
    function SearchViewModelSelector() {
        var _this = _super.call(this, ['search',
        ], getSearchViewModelFromAppState) || this;
        _this.tagList = [{ name: 'visual-studio' }, { name: 'relativitiy-apps' }, { name: 'custom-objects' }, { name: 'agents' }, { name: 'relativity-scripts' }, { name: 'sql-scripts' }, { name: 'testing' }, { name: 'arm' }, { name: 'import-api' }, { name: 'integration-points' }];
        return _this;
    }
...
function getSearchViewModelFromAppState(state) {
    if (state == null)
        return { isVisible: false, searchText: '', tag: { tagItems: [] } };
    return { isVisible: state.header.isHidden, searchText: state.search.searchText, tag: { tagItems: state.tagItems } };
}
...
function searchReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case __WEBPACK_IMPORTED_MODULE_0__actions__["c" /* SearchActions */].EXECUTE_SEARCH:
            newState = __assign({}, state, { searchText: action.data });
            break;
    }
    return newState;
}
